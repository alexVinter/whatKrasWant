...
import { createIdeaMarkerElement } from '../map/createIdeaMarkerElement';
import { getActiveMapStyleProvider } from '../map/providers';
import { isPointInKrasnoyarsk } from '../geo/is-point-in-krasnoyarsk';
import { KRASNOYARSK_GEO_ERROR } from '../geo/krasnoyarsk.constants';
import '../map/maplibreMap.css';
import styles from './IdeaGeoMapPicker.module.css';
